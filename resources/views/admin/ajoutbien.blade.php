    ...
    <div class="p-6 space-y-6">
        <form action="/savebien" method="Post">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="nbrChambre" class="text-sm font-medium text-gray-900 block mb-2">Nombre Chambre</label>
                    <input type="text" name="nbreChambre" id="nbrChambre"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="$2300" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="nbrToilette" class="text-sm font-medium text-gray-900 block mb-2">Nombre Toilette</label>
                    <input type="text" name="nbrToilette" id="nbrToilette"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="$2300" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="nbrEspaceVert" class="text-sm font-medium text-gray-900 block mb-2">Espace Vert</label>
                    <input type="text" name="nbrEspaceVert" id="nbrEspaceVert"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="$2300" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="nbrTo" class="text-sm font-medium text-gray-900 block mb-2">Nombre Balcon</label>
                    <input type="text" name="nbrBalcon" id="nbrBalcon"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="$2300" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="datepub" class="text-sm font-medium text-gray-900 block mb-2">Date publication</label>
